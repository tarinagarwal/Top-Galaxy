  ...
  return (
    <footer className="py-[42px] px-6 text-center border-t border-white/5">
      ...
      <div className="text-[0.7rem] text-white/20 tracking-[0.09em] leading-[1.9]">
        ® Real Cash Game Ecosystem — Binance Smart Chain BEP-20
        <br />
        Risk Notice: Cryptocurrency gaming involves financial risk. Participate responsibly. 18+ only. One account policy applies.
      </div>
    </footer>
  );
}
